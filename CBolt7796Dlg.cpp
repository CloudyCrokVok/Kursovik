...
BOOL CBolt7796Dlg::OnInitDialog()
{
    ...
    { CString __v; __v.Format(L"%.2f", get(14)); SetRO(this, IDC_EDIT_B7796_D2, __v); }
    { CString __v; __v.Format(L"%.2f", get(19)); SetRO(this, IDC_EDIT_B7796_L1, __v); }
    { CString __v; __v.Format(L"%.2f", get(4)); SetRO(this, IDC_EDIT_B7796_K, __v); }
    { CString __v; __v.Format(L"%.2f", get(3)); SetRO(this, IDC_EDIT_B7796_S, __v); }
